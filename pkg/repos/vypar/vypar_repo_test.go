...
func getDummyBusinessAgentMongo(entityId uint64) models.BusinessAgentMongo {
	return models.BusinessAgentMongo{
		EntityID:   entityId,
...
func getDummyBusinessFilingMongo(entityId uint64) models.BusinessFilingMongo {
	return models.BusinessFilingMongo{
		EntityID:               entityId,
		EntityName:             "TestEntity",
