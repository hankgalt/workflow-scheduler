...
func GetMongoConfig() stores.StoreConfig {
...
func GetMongoStore(ctx context.Context, cfg stores.StoreConfig) (stores.DBStore, error) {
	...
	opts := &MongoStoreOption{
		ClientOption: clients.DefaultClientOption(),
